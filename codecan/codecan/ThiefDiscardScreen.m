...
-(id) init{
	...
	if(self = [super init]){
		...
		self.woolQuantity.position = CGPointMake(self.options.size.width*2/6, -50);
		...
		self.lumberQuantity.position = CGPointMake(-self.options.size.width*2/6, -50);
		...
		self.oreQuantity.position = CGPointMake(-self.options.size.width/6, -50);
		...
		self.grainQuantity.position = CGPointMake(self.options.size.width/6, -50);
